// MESSAGE USV_CONNECT_REQUEST support class
...
/**
 * @brief USV_CONNECT_REQUEST message
 *
 * gcs connect request
 */
struct USV_CONNECT_REQUEST : mavlink::Message {
    static constexpr msgid_t MSG_ID = 50001;
    static constexpr size_t LENGTH = 1;
    static constexpr size_t MIN_LENGTH = 1;
    static constexpr uint8_t CRC_EXTRA = 153;
    static constexpr auto NAME = "USV_CONNECT_REQUEST";
