/** @file
 *	@brief MAVLink comm protocol generated from USV.xml
...
/** @brief  */
enum class USV_MSG_SRC : uint8_t
{
    USV=0, /* usv | */
    GCS=1, /* gcs | */
    SERVER=2, /* server | */
...
/** @brief  */
enum class USV_LINK_TYPE : uint8_t
{
    NETWORK=0, /* network | */
    RADIO=1, /* radio | */
...
/** @brief  */
enum class USV_CHANNEL_TYPE : uint8_t
{
    UDP=0, /* udp | */
    WS=1, /* websocket | */
    MQTT=2, /* mqtt | */
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_usv_register_request.hpp"
#include "./mavlink_msg_usv_register_response.hpp"
#include "./mavlink_msg_usv_deregister_request.hpp"
#include "./mavlink_msg_usv_deregister_response.hpp"
